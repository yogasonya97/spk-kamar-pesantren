...
<div class="login">
    <div class="login__content">	
        ...
        <div class="login-form">
            <form id="LoginForm" method="post" action="<?php echo base_url();?>auth/changePassword">
                <div class="login-form__row">
                    <label class="login-form__label">Password Lama</label>
                    <input type="password" name="passwordOld" value="" class="login-form__input required" />
                </div>
                <div class="login-form__row">
                    <label class="login-form__label">Password Baru</label>
                    <input type="password" name="password" value="" class="login-form__input required" />
                </div>
                <div class="login-form__row">
                    <input type="submit" name="submit" class="login-form__submit button button--main button--full" id="submit" value="Ubah" />
                </div>
            </form>
