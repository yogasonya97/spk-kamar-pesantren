            ...
            <div class="splide__slide">
                <div class="card card-style mx-0 shadow-card shadow-card-m bg-14" data-card-height="230">
                    <div class="card-bottom pb-3 px-3">
                        ...
                        <p class="color-white opacity-80 mb-0 mt-n1 font-14">Duo is now Better than Ever!
                        </p>
                    </div>
            ...
            <div class="splide__slide">
                <div class="card card-style mx-0 shadow-card shadow-card-m bg-2" data-card-height="230">
                    <div class="card-bottom pb-3 px-3">
                        ...
                        <p class="color-white opacity-80 mb-0 mt-n1 font-14">Just install it to your Home
                            Screen.</p>
                    </div>
                    <div class="card-overlay bg-gradient-fade"></div>
                </div>
            ...
            <div class="splide__slide">
                <div class="card card-style mx-0 shadow-card shadow-card-m bg-7" data-card-height="230">
                    <div class="card-bottom pb-3 px-3">
                        ...
                        <p class="color-white opacity-80 mb-0 mt-n1">No jQuery Dependency. Fast and Clean
                        </p>
                    </div>
                    <div class="card-overlay bg-gradient-fade"></div>
                </div>
                ...
                <div class="splide__list">
                    <div class="splide__slide">
                        <p class="font-16 font-400 color-white line-height-xl mx-4 mb-0">
                            The best support I have ever had, it's so good I purchased another template.
                    ...
                    <div class="splide__slide">
                        <p class="font-16 font-400 color-white line-height-xl mx-4 mb-0">
                            The code is always great with any Enabled template, but it's the customer
                            support that wins me over.<br>
                            <a href="#" class="pt-4 color-highlight font-13 mb-0">Envato Customer</a>
                        </p>
                    </div>
                </div>
    ...
    <div class="content px-2 text-center">
        ...
        <div class="row text-center row-cols-3 mb-n1">
            <a class="col p-1" data-gallery="gallery-1" href="images/pictures/7t.jpg" title="Vynil and Typerwritter">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/7s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
            <a class="col p-1" data-gallery="gallery-1" href="<?= base_url() ?>assets/mobile/images/pictures/23t.jpg"
                title="Cream Cookie">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/23s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
            <a class="col p-1" data-gallery="gallery-1" href="<?= base_url() ?>assets/mobile/images/pictures/3t.jpg"
                title="Cookies and Flowers">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/3s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
            <a class="col p-1" data-gallery="gallery-1" href="<?= base_url() ?>assets/mobile/images/pictures/11t.jpg"
                title="Vynil and Typerwritter">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/11s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
            <a class="col p-1" data-gallery="gallery-1" href="<?= base_url() ?>assets/mobile/images/pictures/5t.jpg"
                title="Cream Cookie">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/5s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
            <a class="col p-1" data-gallery="gallery-1" href="<?= base_url() ?>assets/mobile/images/pictures/15t.jpg"
                title="Cookies and Flowers">
                <img src="<?= base_url() ?>assets/mobile/images/empty.png"
                    data-src="<?= base_url() ?>assets/mobile/images/pictures/14s.jpg"
                    class="preload-img img-fluid rounded-m" alt="img">
            </a>
        </div>
    </div>
...
<div class="card card-style py-3">
    <div class="content px-2 text-center">
        ...
        <a href="https://1.envato.market/2ryjKA" target="_blank"
            class="default-link btn btn-m rounded-s gradient-highlight shadow-bg shadow-bg-s px-5 mb-0 mt-2">Get
            Duo Now</a>
    </div>
</div>