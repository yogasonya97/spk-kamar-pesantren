<div class="sidebar dz-floting-sidebar">
	<div class="sidebar-header">
		<div class="app-logo">
			<img class="logo-dark" src="<?= base_url() ?>assets/mobile/assets/images/app-logo/logo.png" alt="logo"
				style="max-width: 60px !important;" />
			<img class="logo-white d-none" src="<?= base_url() ?>assets/mobile/assets/images/app-logo/logo.png" alt="logo"
				style="max-width: 60px !important;" />
		</div>
	...
	<ul class="nav navbar-nav">
		<li>
			<a class="nav-link <?php if ($this->uri->segment(3) == null) : ?> active <?php endif; ?>" href="/">
				<span class="dz-icon">
		...
		<li>
			<a class="nav-link <?php if ($this->uri->segment(3) == 'kamar') : ?> active <?php endif; ?>" href="/admin/master/kamar">
				<span class="dz-icon">
		...
		<?php if ($this->session->userdata('role') == '1'): ?>
			<li>
				<a class="nav-link <?php if ($this->uri->segment(3) == 'kriteria') : ?> active <?php endif; ?>" href="/admin/master/kriteria">
					<span class="dz-icon">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
		...
		<?php if ($this->session->userdata('role') == '1'): ?>
		<li>
			<a class="nav-link <?php if ($this->uri->segment(3) == 'users') : ?> active <?php endif; ?>" href="/admin/config/users">
				<span class="dz-icon">
					<svg width="24" height="24" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
						<rect fill="none" height="256" width="256" />
						<line fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" x1="24"
