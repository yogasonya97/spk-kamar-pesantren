    ...
    <!-- <div class="modal fade dz-pwa-modal" id="pwaModal" tabindex="-1" aria-labelledby="pwaModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <img class="logo dark" src="<?= base_url() ?>assets/mobile/assets/images/app-logo/logo.png" alt="" />
          <img class="logo light" src="<?= base_url() ?>assets/mobile/assets/images/app-logo/logo-white.png" alt="" />
